...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { dataNascimento: @contato.dataNascimento, email: @contato.email, endereco: @contato.endereco, nome: @contato.nome } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { dataNascimento: @contato.dataNascimento, email: @contato.email, endereco: @contato.endereco, nome: @contato.nome } }

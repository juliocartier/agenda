...
class TelefonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefone" do
    assert_difference('Telefone.count') do
      post telefones_url, params: { telefone: { nome: @telefone.nome, numero: @telefone.numero } }
    end
  ...
  test "should update telefone" do
    patch telefone_url(@telefone), params: { telefone: { nome: @telefone.nome, numero: @telefone.numero } }
